...
const Certification = ({examinee="Yosef Lakew",exam="Data Analysis with Python", examDate="March 21, 2024", score="90%", org="AASTU"}) => {
...
<div className='flex justify-between gap-4 items-center'>
        <div className='flex gap-4 items-center '>
          <Link to='/dashboard/certifications'>
           ...
           <h1 className='text-2xl font-bold text-blue-900 text-left'>Certificate</h1>
        </div>
        ...
        <div className="flex flex-col justify-center" ref={printableContentRef} >
          <div className="flex flex-col items-center  pb-2.5 w-full border-blue-900 border-solid border-[11px]" >
            ...
            <div className="mt-5 text-2xl leading-7 text-center text-slate-900">
              Exam from <span className='text-blue-800 font-semibold'>{org}</span> organization with a score of <span className='text-blue-800 font-semibold'>{score}</span> on <span className='text-blue-800 font-semibold'>{examDate}</span>
            </div>
