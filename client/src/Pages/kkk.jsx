            ...
            {question.questionType === "True/False" ? (
              <Card className='bg-gray-50 w-5/6 mx-auto my-2'>
                <div className='flex gap-8 items-center justify-between mx-4 border-b'>
                  ...
                  <Form.Item
                    ...
                    <InputNumber
                      ...
                      onChange={(value) => trueFalseOnChange("points", value)}
                    />
                  </Form.Item>
                </div>
                <div className='mt-4 mx-4'>
                  <Form.Item
                    ...
                    rules={[
                      {
                        required: true,
                        message: "Please enter the exam question!",
                      },
                    ]}>
                    <Input
                      value={question.questionText}
                      onChange={(e) =>
                        trueFalseOnChange("questionText", e.target.value)
                      }
                    />
                  </Form.Item>
                </div>
                <div className='mt-4 flex items-start mx-4'>
                  <Form.Item
                    ...
                    <Select
                      ...
                      onChange={(value) =>
                        trueFalseOnChange("correctAnswer", value)
                      }>
                ...
                <div className='flex justify-end'>
                  <Button
                    className='px-16 mx-4 border-blue-300'
                    onClick={() => handleQuestionsSave("True/False", index)}>
                    Edit
                  </Button>
                </div>
              </Card>
                ...
                <div className='mt-4 mx-4'>
                  <Form.Item
                    ...
                    <Input
                      value={question.questionText}
                      onChange={(e) =>
                        chooseOnChange("questionText", e.target.value)
                      }
                    />
                  </Form.Item>
                </div>
                <div className='mt-4 w-full flex items-start mx-4 gap-4'>
                  <Form.Item
                    ...
                    rules={[
                      {
                        required: true,
                        message: "Please select the choice number",
                      },
                    ]}
                    className='w-48'>
                    <Select
                      onChange={(value) => setChoiceCount(value)}
                      defaultValue={2}>
                      {[2, 3, 4, 5].map((count) => (
                        <Select.Option
                          key={count}
                  ...
                  <div className='flex flex-col'>
                    <Radio.Group
                      value={question.correctAnswer}
                      onChange={(e) =>
                        chooseOnChange("correctAnswer", e.target.value)
                      }>
                      {Array.from({ length: choiceCount }).map((_, index) => (
                        <Form.Item
                          ...
                          rules={[
                            {
                              required: true,
                              message: `Please enter choice ${String.fromCharCode(
                                65 + index
                              )}`,
                            },
                          ]}>
                          <div className='flex gap-4'>
                            <Input
                              onChange={(e) =>
                                chooseOnChange("questionChoice", {
                                  [index]: e.target.value,
                                })
                              }
                              value={question.questionChoice[index]}
                            />
              ...
              <Card className='bg-gray-50 w-5/6 mx-auto my-8'>
                ...
                <div className='mt-4 flex items-start mx-4 mb-4'>
                  <TextArea
                    ...
                    onChange={(e) =>
                      shortAnswerOnChange("questionText", e.target.value)
                    }
                    value={question.questionText}
                  />
                </div>
              ...
              <Card className='bg-gray-50 w-5/6 mx-auto my-8'>
                <div className='flex gap-8 items-center justify-between mx-4 border-b'>
                  <h3 className='text-blue-900 font-semibold text-lg'>
                    Question {questionsCollection.length + 1}
                  </h3>
                  {/* <Radio.Group value={size} onChange={(e) => setSize(e.target.value)}> */}
                  <Form.Item
                    label='points'
                ...
                <div className='mt-4 flex items-start mx-4 mb-4'>
                  <TextArea
                    ...
                    placeholder='Enter your question here'
                    onChange={(e) =>
                      essayOnChange("questionText", e.target.value)
                    }
                    value={question.questionText}
