...
const handlePrint = () => {
  ...
  return (
    ...
    <Link to='/dashboard/exams'>
      ...
      <button onClick={handlePrint} className="px-16 py-[0.35rem] text-blue-800 border border-primary-600 rounded-md hover:bg-primary-700 hover:text-white font-bold">Print</button>
       </div>
...
<p className="font-semibold"><span className="font-bold text-blue-700">Points : </span>{exam.points}</p>
{/* <p className="font-semibold"><span className="font-bold text-blue-700">Questions : </span>{questionsCollection.length}</p> */}
<p className="font-semibold"><span className="font-bold text-blue-700">Time limit : </span>{exam.duration} Minutes</p>
...
<p className="font-bold mt-4">Good Luck!</p>
  ...
  <p className="font-semibold">
    <span className="font-bold text-blue-700">Private Answer : </span>{exam.privateAnswer ? "Yes" : "No"}
  </p>
  <p className="font-semibold">
    <span className="font-bold text-blue-700">Private Score : </span>{exam.privateScore ? "Yes" : "No"}
  </p>
  <p className="font-semibold">
    <span className="font-bold text-blue-700">Security level : </span>{exam.securityLevel}
  </p>
  <p className="font-semibold">
    <span className="font-bold text-blue-700">Exam type : </span>{exam.examType}
  </p>
</div>

<div className="w-full flex flex-wrap justify-between py-2 px-8 rounded-sm border mt-4">
  <p className="font-semibold">
    <span className="font-bold text-blue-700">Calculator : </span>{exam.toolsPermitted.includes('calculator') ? "Yes" : "No"}
  </p>
  <p className="font-semibold">
    <span className="font-bold text-blue-700">Formulas Collection : </span>{exam.formulasCollection ? "Yes" : "No"}
  </p>
  <p className="font-semibold">
    <span className="font-bold text-blue-700">Upload Materials : </span>{exam.uploadMaterials ? "Yes" : "No"}
  </p>
</div>
