    ...
    <>
      <Form.Item name="instruction">
        <div className="flex justify-center items-center gap-2 mb-8 mt-4">
          <Icon
            icon="icon-park-outline:instruction"
            className="text-2xl font-bold text-blue-800 lg:flex hidden"
          />
        ...
        <ReactQuill
          ...
          onChange={(value) => {
            setBasicInfoValues({ ...basicInfoValues, instruction: value });
          }}
          modules={modules}
          formats={formats}
        />
      ...
      <div className="flex justify-end mt-8">
        <Button
          className="px-16 bg-primary-500 mt-4"
          type="primary"
