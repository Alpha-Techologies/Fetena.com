        ...
        <div className="flex gap-5 max-md:flex-col max-md:gap-0">
          <div className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full">
            <div className="flex flex-col items-center self-stretch pt-1.5 pr-6 pb-8 my-auto max-md:mt-16 max-md:max-w-full">
              ...
              Revolutionize Your Exam Process with Fetena <br /> 
              </h1>
              <p className="mt-8 text-base leading-7 text-white max-md:max-w-full">
              Fetena.com makes it easy for examiners to create, conduct, and grade exams online, while ensuring a secure and seamless experience for examinees.              </p>
